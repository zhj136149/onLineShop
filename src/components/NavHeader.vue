      ...
      <svg style="position: absolute; width: 0; height: 0; overflow: hidden;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                ...
                <a href="javascript:void(0)" class="navbar-link" @click="logOut" v-else>退出登录</a>
              ...
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input regi_login_input_left" placeholder="请输入您的账号" data-type="loginname">
                  </li>
        ...
        <div class="md-overlay" v-if="loginModalFlag" @click="loginModalFlag=false"></div>
         ...
         <!-- 注册弹窗-->
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">新用户注册</div>
              <button class="md-close" @click="registerModalFlag=false">Close</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="errorTip">请填写正确的注册信息</span>
                </div>
                <ul>
                  <li class="regi_form_input">
                    <i class="icon IconPeople"></i>
                    <input type="text" tabindex="1" name="registername" v-model="myuserName" class="regi_login_input regi_login_input_left" placeholder="请注册您的账号" data-type="registername">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="registerpassword" v-model="myuserPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="请注册您的账户密码" @keyup.enter="register">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" class="btn-register" @click="register">注 册</a>
              </div>
            </div>
          </div>
        </div>
...
<script>
    ...
    export default{
        ...
        methods:{
                ...
                axios.post("/users/login",{
                  ...
                  userPwd:this.userPwd
                    ...
                    if(res.status =='0'){
                      this.errorTip = false;
                      this.loginModalFlag = false;
                      this.$store.commit("updateUserInfo",userdata.userName);
                      this.getCartCount();
                      alert('恭喜您，登录成功！');
                      loginModalFlag = false;
                    }else{
           ...
           register(){
               if(!this.myuserName || !this.myuserPwd){
                    this.errorTip = true;
